...
EXPORT_TREE_PATH = Path('./figures/crowdsignals_ch7_classification_own/')
...
selected_features=['acc_phone_y_freq_0.0_Hz_ws_40', 'pca_3_temp_mean_ws_120', 'mag_phone_y_temp_std_ws_120', 'acc_phone_y',
                   'acc_phone_y_freq_0.4_Hz_ws_40', 'pca_3', 'acc_phone_z_max_freq', 'mag_phone_x_freq_1.1_Hz_ws_40',
                   'acc_phone_y_freq_weighted', 'mag_phone_y_freq_weighted']
...
for reg_param in reg_parameters:
    print('reg_parameter', reg_param)
    performance_tr = 0
    performance_te = 0
    for i in range(0, N_REPEATS_NN):
        print('running NN repeat', i, 'for reg_parameter', reg_param)
        ...
        print('finished NN repeat',i,'for reg_parameter', reg_param)
...
for i in range(0, len(possible_feature_sets)):
    ...
    for repeat in range(0, N_KCV_REPEATS):
        ...
        print('finished N_KCV repeat', repeat)
    ...
    print('finished possible feature set', i)
